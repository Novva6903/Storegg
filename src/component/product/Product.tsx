...
import { IIdParams, IProductAPIResult, ISearchParams } from '../../config/interface'
...
// Note: Jika API sedang tidak bisa load, maka:
//       1. gunakan/uncomment const listProduct
//       2. comment useEffect() + isinya
//       3. ganti filter.map... di function ShowProductGrid dan ShowProductList dengan listProduct.map...
    ...
    const ShowProductGrid = () => {
        ...
        return (
            <>
                                ...
                                return (
                                    <div className='grid-home'>
                                        ...
                                        <div className='button-box'>
                                            <Link to={(url === "/products/") ? `${url}` + product.id : `${url}/` + product.id}><button className="btn btn-primary">View Product Detail</button></Link>
                                        </div>
                                    </div>
                                )
                            }
                ...
                {(found !== 0) ? <></> : <img src={notFound} className='not-found' />}
            </>
        )
    }
